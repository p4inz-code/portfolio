...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: 'ascent',
    name: 'Project Ascent',
    tagline: 'A 2D precision platformer built for movement and feel.',
    description:
      'Offline-first, browser-first 2D precision platformer built in Godot 4, focused on movement, atmosphere, and audiovisual polish. No accounts, no backend, no ads. AI handles the coding; creative direction, art, and playtesting stay human. Currently a private prototype validating core movement.',
    status: { kind: 'testing', label: 'Private Prototype' },
    tags: ['Godot 4', 'GDScript', 'Private'],
    metaTags: ['Godot 4', 'GDScript', 'Offline-First'],
    featured: false,
    order: 5,
    href: '',
    isExternal: false,
    ...
    role: 'Creative direction & oversight (AI-assisted implementation)',
    started: 'August 2026',
    nextMilestone: 'Movement validation — proving out core platforming feel before scope grows.',
    notes: 'In planning for about two months before development began August 26, 2026. Repo is private; nothing public yet.',
  },
  {
    slug: 'obscura',
    name: 'Obscura',
